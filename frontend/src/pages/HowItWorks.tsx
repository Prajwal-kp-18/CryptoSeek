  ...
  const steps = [
    {
      ...
      description:
        "Upload your firmware or binary file through CRYPTOSEEK’s secure interface. We support ELF, BIN, HEX, raw dumps, and extracted file systems from routers, IoT devices, industrial and automotive systems.",
      features: [
...

    {
      ...
      description:
        "CRYPTOSEEK extracts opcode patterns, instruction sequences, CFG graphs, n-grams, entropy spikes, key-schedule patterns, and potential crypto constants using Ghidra, Radare2, capstone, objdump and QEMU emulation.",
      features: [
...

    {
      ...
      description:
        "CRYPTOSEEK generates a comprehensive analysis report including detected cryptographic functions, protocol states, key-materials nearby, CFG visualizations, opcode similarities and explainable ML insights.",
      features: [
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-primary">
                CRYPTOSEEK Firmware Analysis Pipeline
              </span>
            </motion.div>
            ...
            >
              How <span className="text-primary cyber-glow">CRYPTOSEEK</span> Works
            </motion.h1>
        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              CRYPTOSEEK combines ML, graph processing, dynamic emulation and crypto intelligence.
            </p>
          </motion.div>
